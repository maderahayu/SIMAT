            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-body">
                        ...
                        @endif
                        <a href="{{ route('createKelompok') }}" class="btn btn-primary mb-3"><i class="fas fa-plus" style="margin-right: 10px;"></i>Buat Kelompok</a>
                            ...
                            <table class="table table-bordered table-hover" id="table" width="100%" cellspacing="0">
                                <thead>
                                    <tr class="table-secondary">
                                        ...
                                        <th scope="col" class="text-center">Nama Kelompok</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $k->namaKelompok }}</td>
                                        <td class="text-center">
                                            <a class="btn btn-success" href="{{ route('editKelompok', $k->kelompokId)}}" role="button" style="margin-right:5px"><i class="fa fa-pen"></i></a>
                                            <a class="btn btn-danger" href="{{ route('deleteKelompok', $k->kelompokId)}}" role="button" onclick="return confirm('Apakah Anda Yakin Menghapus Data?');"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
